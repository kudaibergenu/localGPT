...
class ChatUI {
   ...
   */
  public static CreateAsync = async (chat: ChatInterface) => {
    ...
    chatUI.uiChatInput.addEventListener("keydown", function(event) {
      if (event.key === "Enter") {
    ...
    chatUI.appendMessage("init", "Welcome to LocalGPT! All interactions are processed <strong>locally on your device</strong>, ensuring that your <strong>data does not leave your computer</strong>. You can use the app <strong>offline</strong> after first setup.");
